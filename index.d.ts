...
export interface PushNotificationIOSStatic {
   ...
   * soundName : The sound played when the notification is fired (optional). The file should be added in the ios project from Xcode, on your target, so that it is bundled in the final appFor more details see the example app.
